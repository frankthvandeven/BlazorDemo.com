...
namespace BlazorDemo.Server.VenturaRecordsets
{
	...
	/// </summary>
	public partial class Cust_Recordset : ResultsetObservable<Cust_Recordset, Cust_Record>, IRecordsetBase
	{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Cust_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Cust_Record record)
		{
			int index = this.RecordCount;
		...
		public Cust_Record NewRecord()
		{
			return new Cust_Record();
		}

		protected override Cust_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Cust_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 102, 80, 73, 224, 53, 78, 76, 82, 82, 199, 226, 83, 115, 250, 54, 58 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "665049E0354E4C5252C7E25373FA363A"; }
		}
	...
	public sealed partial class Cust_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Cust_Record(object[] columnvalues)
		{
...
namespace BlazorDemo.Server.VenturaRecordsets
{
	public partial class Cust_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
