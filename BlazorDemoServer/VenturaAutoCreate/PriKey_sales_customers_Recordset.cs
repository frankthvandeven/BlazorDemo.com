...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class PriKey_sales_customers_Recordset : ResultsetObservable<PriKey_sales_customers_Recordset, PriKey_sales_customers_Record>, IRecordsetBase
    {
        ...
        public PriKey_sales_customers_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT [customer_id],[first_name],[last_name],[phone],[email],[street],[city],[state],[zip_code]" + CRLF +
                         "FROM [sales].[customers]" + CRLF +
            ...
            param_array.AddParameterColumn("@customer_id", typeof(int), true, false, DbType.Int32, null, null, null);
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new PriKey_sales_customers_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(PriKey_sales_customers_Record record)
        {
            int index = this.RecordCount;
        ...
        public PriKey_sales_customers_Record NewRecord()
        {
            return new PriKey_sales_customers_Record();
        }

        protected override PriKey_sales_customers_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_sales_customers_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 132, 203, 230, 138, 178, 12, 246, 171, 184, 154, 96, 31, 15, 20, 197, 225 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "84CBE68AB20CF6ABB89A601F0F14C5E1"; }
        }
        ...
        public void SetExecSqlParams(int? customer_id)
        {
            _inputparametervalues[0] = customer_id;
        }

        public void ExecSql(int? customer_id)
        {
            _inputparametervalues[0] = customer_id;
            Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
        }

        public void ExecSql(Connector connector, int? customer_id)
        {
            _inputparametervalues[0] = customer_id;
            Transactional.ExecSql(connector, new IRecordsetBase[] { this });
        }

        public async Task ExecSqlAsync(int? customer_id)
        {
            _inputparametervalues[0] = customer_id;
            await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
        }

        public async Task ExecSqlAsync(Connector connector, int? customer_id)
        {
            _inputparametervalues[0] = customer_id;
    ...
    public sealed partial class PriKey_sales_customers_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public PriKey_sales_customers_Record()
        {
            _cur__customer_id = 0;
            _cur__first_name = "";
            _cur__last_name = "";
        ...
        public PriKey_sales_customers_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class PriKey_sales_customers_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
