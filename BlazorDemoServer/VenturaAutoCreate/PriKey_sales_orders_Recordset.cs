...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class PriKey_sales_orders_Recordset : ResultsetObservable<PriKey_sales_orders_Recordset, PriKey_sales_orders_Record>, IRecordsetBase
    {
        ...
        public PriKey_sales_orders_Recordset()
        {
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new PriKey_sales_orders_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(PriKey_sales_orders_Record record)
        {
            int index = this.RecordCount;
        ...
        public PriKey_sales_orders_Record NewRecord()
        {
            return new PriKey_sales_orders_Record();
        }

        protected override PriKey_sales_orders_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_sales_orders_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 75, 79, 124, 86, 155, 203, 229, 90, 25, 230, 79, 135, 9, 249, 132, 24 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "4B4F7C569BCBE55A19E64F8709F98418"; }
        }
        ...
        public void SetExecSqlParams(int? order_id)
        {
            _inputparametervalues[0] = order_id;
        }

        public void ExecSql(int? order_id)
        {
            _inputparametervalues[0] = order_id;
            Transactional.ExecSql(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
        }

        public void ExecSql(Connector connector, int? order_id)
        {
            _inputparametervalues[0] = order_id;
            Transactional.ExecSql(connector, new IRecordsetBase[] { this });
        }

        public async Task ExecSqlAsync(int? order_id)
        {
            _inputparametervalues[0] = order_id;
            await Transactional.ExecSqlAsync(VenturaSqlConfig.DefaultConnector, new IRecordsetBase[] { this });
        }

        public async Task ExecSqlAsync(Connector connector, int? order_id)
        {
            _inputparametervalues[0] = order_id;
    ...
    public sealed partial class PriKey_sales_orders_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public PriKey_sales_orders_Record()
        {
            _cur__order_id = 0;
        ...
        public PriKey_sales_orders_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class PriKey_sales_orders_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
