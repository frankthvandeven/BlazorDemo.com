...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class PriKey_sales_order_items_Recordset : ResultsetObservable<PriKey_sales_order_items_Recordset, PriKey_sales_order_items_Record>, IRecordsetBase
	{
		...
		public PriKey_sales_order_items_Recordset()
		{
			...
			param_array.AddParameterColumn("@item_id", typeof(int), true, false, DbType.Int32, null, null, null);
		...
		public void Append()
		{
			...
			this.InsertItem(index, new PriKey_sales_order_items_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(PriKey_sales_order_items_Record record)
		{
			int index = this.RecordCount;
		...
		public PriKey_sales_order_items_Record NewRecord()
		{
			return new PriKey_sales_order_items_Record();
		}

		protected override PriKey_sales_order_items_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_sales_order_items_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 60, 74, 42, 141, 115, 49, 150, 192, 105, 75, 73, 55, 197, 245, 64, 69 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "3C4A2A8D733196C0694B4937C5F54045"; }
		}
		...
		public void SetExecSqlParams(int? order_id, int? item_id)
		{
			_inputparametervalues[0] = order_id;
			_inputparametervalues[1] = item_id;
		}

		public void ExecSql(int? order_id, int? item_id)
		{
			_inputparametervalues[0] = order_id;
			_inputparametervalues[1] = item_id;
		...
		public void ExecSql(Connector connector, int? order_id, int? item_id)
		{
			_inputparametervalues[0] = order_id;
			_inputparametervalues[1] = item_id;
		...
		public async Task ExecSqlAsync(int? order_id, int? item_id)
		{
			_inputparametervalues[0] = order_id;
			_inputparametervalues[1] = item_id;
		...
		public async Task ExecSqlAsync(Connector connector, int? order_id, int? item_id)
		{
			_inputparametervalues[0] = order_id;
			_inputparametervalues[1] = item_id;
	...
	public sealed partial class PriKey_sales_order_items_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public PriKey_sales_order_items_Record()
		{
			_cur__order_id = 0;
			_cur__item_id = 0;
			_cur__product_id = 0;
		...
		public PriKey_sales_order_items_Record(object[] columnvalues)
		{
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class PriKey_sales_order_items_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
