...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class Incr_sales_stores_Recordset : ResultsetObservable<Incr_sales_stores_Recordset, Incr_sales_stores_Record>, IRecordsetBase, IRecordsetIncremental
	{
		...
		public Incr_sales_stores_Recordset()
		{
			_resultsets = new IResultsetBase[] { this };

			_sqlscript = "SELECT [store_id],[store_name],[phone],[email],[street],[city],[state],[zip_code]" + CRLF +
			             "FROM [sales].[stores]" + CRLF +
			             "ORDER BY [store_id]" + CRLF +
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Incr_sales_stores_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Incr_sales_stores_Record record)
		{
			int index = this.RecordCount;
		...
		public Incr_sales_stores_Record NewRecord()
		{
			return new Incr_sales_stores_Record();
		}

		protected override Incr_sales_stores_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_sales_stores_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 178, 98, 180, 177, 75, 58, 98, 167, 194, 65, 113, 155, 119, 152, 147, 143 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "B262B4B14B3A62A7C241719B7798938F"; }
		}
	...
	public sealed partial class Incr_sales_stores_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Incr_sales_stores_Record()
		{
			_cur__store_id = 0;
			_cur__store_name = "";
			_cur__phone = null;
		...
		public Incr_sales_stores_Record(object[] columnvalues)
		{
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class Incr_sales_stores_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
