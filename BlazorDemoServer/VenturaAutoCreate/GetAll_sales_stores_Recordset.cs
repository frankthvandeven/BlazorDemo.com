...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class GetAll_sales_stores_Recordset : ResultsetObservable<GetAll_sales_stores_Recordset, GetAll_sales_stores_Record>, IRecordsetBase
    {
        ...
        public GetAll_sales_stores_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT TOP(@RowLimit) [store_id],[store_name],[phone],[email],[street],[city],[state],[zip_code]" + CRLF +
                         "FROM [sales].[stores]";
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new GetAll_sales_stores_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(GetAll_sales_stores_Record record)
        {
            int index = this.RecordCount;
        ...
        public GetAll_sales_stores_Record NewRecord()
        {
            return new GetAll_sales_stores_Record();
        }

        protected override GetAll_sales_stores_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_sales_stores_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 247, 115, 197, 105, 107, 224, 239, 165, 186, 67, 233, 78, 19, 5, 25, 165 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "F773C5696BE0EFA5BA43E94E130519A5"; }
        }
    ...
    public sealed partial class GetAll_sales_stores_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public GetAll_sales_stores_Record()
        {
            _cur__store_id = 0;
            _cur__store_name = "";
            _cur__phone = null;
        ...
        public GetAll_sales_stores_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class GetAll_sales_stores_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
