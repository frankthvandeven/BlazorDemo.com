...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class Incr_sales_order_items_Recordset : ResultsetObservable<Incr_sales_order_items_Recordset, Incr_sales_order_items_Record>, IRecordsetBase, IRecordsetIncremental
	{
		...
		public Incr_sales_order_items_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new Incr_sales_order_items_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(Incr_sales_order_items_Record record)
		{
			int index = this.RecordCount;
		...
		public Incr_sales_order_items_Record NewRecord()
		{
			return new Incr_sales_order_items_Record();
		}

		protected override Incr_sales_order_items_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_sales_order_items_Record(columnvalues);
	...
	public sealed partial class Incr_sales_order_items_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public Incr_sales_order_items_Record()
		{
			_cur__order_id = 0;
			_cur__item_id = 0;
			_cur__product_id = 0;
		...
		public Incr_sales_order_items_Record(object[] columnvalues)
		{
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class Incr_sales_order_items_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
