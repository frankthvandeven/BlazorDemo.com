...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	...
	/// </summary>
	public partial class GetAll_production_products_Recordset : ResultsetObservable<GetAll_production_products_Recordset, GetAll_production_products_Record>, IRecordsetBase
	{
		...
		public GetAll_production_products_Recordset()
		{
		...
		public void Append()
		{
			...
			this.InsertItem(index, new GetAll_production_products_Record());
			this.CurrentRecordIndex = index;
		}

		public void Append(GetAll_production_products_Record record)
		{
			int index = this.RecordCount;
		...
		public GetAll_production_products_Record NewRecord()
		{
			return new GetAll_production_products_Record();
		}

		protected override GetAll_production_products_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_production_products_Record(columnvalues);

		byte[] IRecordsetBase.Hash
		{
			get { return new byte[] { 168, 139, 148, 185, 116, 178, 201, 70, 154, 63, 150, 16, 175, 195, 148, 45 }; }
		}

		string IRecordsetBase.HashString
		{
			get { return "A88B94B974B2C9469A3F9610AFC3942D"; }
		}
	...
	public sealed partial class GetAll_production_products_Record : IRecordBase, INotifyPropertyChanged
	{
		...
		public GetAll_production_products_Record()
		{
			_cur__product_id = 0;
			_cur__product_name = "";
			_cur__brand_id = 0;
		...
		public GetAll_production_products_Record(object[] columnvalues)
		{
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class GetAll_production_products_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
