...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class GetAll_sales_customers_Recordset : ResultsetObservable<GetAll_sales_customers_Recordset, GetAll_sales_customers_Record>, IRecordsetBase
    {
        ...
        public GetAll_sales_customers_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT TOP(@RowLimit) [customer_id],[first_name],[last_name],[phone],[email],[street],[city],[state],[zip_code]" + CRLF +
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new GetAll_sales_customers_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(GetAll_sales_customers_Record record)
        {
            int index = this.RecordCount;
        ...
        public GetAll_sales_customers_Record NewRecord()
        {
            return new GetAll_sales_customers_Record();
        }

        protected override GetAll_sales_customers_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_sales_customers_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 166, 251, 218, 244, 92, 147, 215, 93, 217, 227, 162, 137, 245, 106, 101, 126 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "A6FBDAF45C93D75DD9E3A289F56A657E"; }
        }
    ...
    public sealed partial class GetAll_sales_customers_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public GetAll_sales_customers_Record()
        {
            _cur__customer_id = 0;
            _cur__first_name = "";
            _cur__last_name = "";
        ...
        public GetAll_sales_customers_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class GetAll_sales_customers_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
