...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class Incr_production_stocks_Recordset : ResultsetObservable<Incr_production_stocks_Recordset, Incr_production_stocks_Record>, IRecordsetBase, IRecordsetIncremental
    {
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new Incr_production_stocks_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(Incr_production_stocks_Record record)
        {
            int index = this.RecordCount;
        ...
        public Incr_production_stocks_Record NewRecord()
        {
            return new Incr_production_stocks_Record();
        }

        protected override Incr_production_stocks_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_production_stocks_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 115, 153, 159, 129, 71, 62, 31, 115, 68, 61, 116, 11, 198, 104, 138, 213 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "73999F81473E1F73443D740BC6688AD5"; }
        }
    ...
    public sealed partial class Incr_production_stocks_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public Incr_production_stocks_Record()
        {
            _cur__store_id = 0;
            _cur__product_id = 0;
            _cur__quantity = null;
        ...
        public Incr_production_stocks_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class Incr_production_stocks_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
