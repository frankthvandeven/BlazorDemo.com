...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class PriKey_production_stocks_Recordset : ResultsetObservable<PriKey_production_stocks_Recordset, PriKey_production_stocks_Record>, IRecordsetBase
    {
        ...
        public PriKey_production_stocks_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT [store_id],[product_id],[quantity]" + CRLF +
                         "FROM [production].[stocks]" + CRLF +
                         "WHERE [store_id] = @store_id" + CRLF +
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new PriKey_production_stocks_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(PriKey_production_stocks_Record record)
        {
            int index = this.RecordCount;
        ...
        public PriKey_production_stocks_Record NewRecord()
        {
            return new PriKey_production_stocks_Record();
        }

        protected override PriKey_production_stocks_Record InternalCreateExistingRecordObject(object[] columnvalues) => new PriKey_production_stocks_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 154, 75, 157, 208, 255, 104, 55, 213, 155, 253, 1, 161, 3, 211, 192, 243 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "9A4B9DD0FF6837D59BFD01A103D3C0F3"; }
        }
        ...
        public void SetExecSqlParams(int? store_id, int? product_id)
        {
            _inputparametervalues[0] = store_id;
            _inputparametervalues[1] = product_id;
        }

        public void ExecSql(int? store_id, int? product_id)
        {
            _inputparametervalues[0] = store_id;
            _inputparametervalues[1] = product_id;
        ...
        public void ExecSql(Connector connector, int? store_id, int? product_id)
        {
            _inputparametervalues[0] = store_id;
            _inputparametervalues[1] = product_id;
        ...
        public async Task ExecSqlAsync(int? store_id, int? product_id)
        {
            _inputparametervalues[0] = store_id;
            _inputparametervalues[1] = product_id;
        ...
        public async Task ExecSqlAsync(Connector connector, int? store_id, int? product_id)
        {
            _inputparametervalues[0] = store_id;
            _inputparametervalues[1] = product_id;
    ...
    public sealed partial class PriKey_production_stocks_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public PriKey_production_stocks_Record()
        {
            _cur__store_id = 0;
            _cur__product_id = 0;
            _cur__quantity = null;
        ...
        public PriKey_production_stocks_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class PriKey_production_stocks_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
