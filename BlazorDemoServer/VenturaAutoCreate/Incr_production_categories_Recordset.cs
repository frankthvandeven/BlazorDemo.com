...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class Incr_production_categories_Recordset : ResultsetObservable<Incr_production_categories_Recordset, Incr_production_categories_Record>, IRecordsetBase, IRecordsetIncremental
    {
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new Incr_production_categories_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(Incr_production_categories_Record record)
        {
            int index = this.RecordCount;
        ...
        public Incr_production_categories_Record NewRecord()
        {
            return new Incr_production_categories_Record();
        }

        protected override Incr_production_categories_Record InternalCreateExistingRecordObject(object[] columnvalues) => new Incr_production_categories_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 71, 218, 53, 178, 46, 143, 161, 11, 220, 81, 245, 239, 81, 82, 17, 146 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "47DA35B22E8FA10BDC51F5EF51521192"; }
        }
    ...
    public sealed partial class Incr_production_categories_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public Incr_production_categories_Record()
        {
            _cur__category_id = 0;
            _cur__category_name = "";
        ...
        public Incr_production_categories_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class Incr_production_categories_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
