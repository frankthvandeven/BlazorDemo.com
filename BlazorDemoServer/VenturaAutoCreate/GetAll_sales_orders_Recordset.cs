...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class GetAll_sales_orders_Recordset : ResultsetObservable<GetAll_sales_orders_Recordset, GetAll_sales_orders_Record>, IRecordsetBase
    {
        ...
        public GetAll_sales_orders_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT TOP(@RowLimit) [order_id],[customer_id],[order_status],[order_date],[required_date],[shipped_date],[store_id],[staff_id]" + CRLF +
                         "FROM [sales].[orders]";
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new GetAll_sales_orders_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(GetAll_sales_orders_Record record)
        {
            int index = this.RecordCount;
        ...
        public GetAll_sales_orders_Record NewRecord()
        {
            return new GetAll_sales_orders_Record();
        }

        protected override GetAll_sales_orders_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_sales_orders_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 95, 126, 255, 156, 180, 148, 178, 208, 44, 204, 211, 65, 30, 248, 34, 137 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "5F7EFF9CB494B2D02CCCD3411EF82289"; }
        }
    ...
    public sealed partial class GetAll_sales_orders_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public GetAll_sales_orders_Record()
        {
            _cur__order_id = 0;
        ...
        public GetAll_sales_orders_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class GetAll_sales_orders_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
