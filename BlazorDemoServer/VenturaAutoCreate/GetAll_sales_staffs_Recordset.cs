...
namespace BlazorDemo.Server.VenturaAutoCreate
{
    ...
    /// </summary>
    public partial class GetAll_sales_staffs_Recordset : ResultsetObservable<GetAll_sales_staffs_Recordset, GetAll_sales_staffs_Record>, IRecordsetBase
    {
        ...
        public GetAll_sales_staffs_Recordset()
        {
            _resultsets = new IResultsetBase[] { this };

            _sqlscript = "SELECT TOP(@RowLimit) [staff_id],[first_name],[last_name],[email],[phone],[active],[store_id],[manager_id]" + CRLF +
                         "FROM [sales].[staffs]";
        ...
        public void Append()
        {
            ...
            this.InsertItem(index, new GetAll_sales_staffs_Record());
            this.CurrentRecordIndex = index;
        }

        public void Append(GetAll_sales_staffs_Record record)
        {
            int index = this.RecordCount;
        ...
        public GetAll_sales_staffs_Record NewRecord()
        {
            return new GetAll_sales_staffs_Record();
        }

        protected override GetAll_sales_staffs_Record InternalCreateExistingRecordObject(object[] columnvalues) => new GetAll_sales_staffs_Record(columnvalues);

        byte[] IRecordsetBase.Hash
        {
            get { return new byte[] { 66, 60, 23, 123, 100, 47, 36, 151, 122, 160, 251, 103, 226, 71, 243, 160 }; }
        }

        string IRecordsetBase.HashString
        {
            get { return "423C177B642F24977AA0FB67E247F3A0"; }
        }
    ...
    public sealed partial class GetAll_sales_staffs_Record : IRecordBase, INotifyPropertyChanged
    {
        ...
        public GetAll_sales_staffs_Record()
        {
            _cur__staff_id = 0;
            _cur__first_name = "";
            _cur__last_name = "";
        ...
        public GetAll_sales_staffs_Record(object[] columnvalues)
        {
...
namespace BlazorDemo.Server.VenturaAutoCreate
{
	public partial class GetAll_sales_staffs_Record
	{
		partial void OnAfterPropertyChanged(string propertyName)
		{
