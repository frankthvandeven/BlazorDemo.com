...
namespace Kenova.Client.Components
{
    ...
    public partial class RadioGroup : KenovaComponentBase, IRerender, IAsyncDisposable, IKenovaComponent
    {
        private string container_id = KenovaClientConfig.GetUniqueElementID();
        private ComponentWingman<RadioGroup> _wingman = new();
        private List<RadioButton> Buttons { get; set; } = new();

        internal FieldLink<string> SelectedFieldLink { get; private set; }
        ...
        internal void Register(RadioButton button)
        {
            this.Buttons.Add(button);
        }

        internal void Unregister(RadioButton button)
        {
